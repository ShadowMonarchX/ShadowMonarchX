...
| Category | Skills |
|----------|--------|
| AI & LLMs | LLMs, RAG, AI Agents, Prompt Engineering, LangChain, LangGraph |
| ML & DL | PyTorch, Scikit-learn, Fine-Tuning, LoRA, Embeddings |
| Backend | Python, FastAPI, REST APIs, AsyncIO |
| Vector DBs | FAISS, Semantic Search, Knowledge Retrieval |
| Data | Pandas, NumPy, ETL, Data Processing |
| MLOps | Docker, Git, GitHub Actions, CI/CD, Linux |
| Automation | n8n, Workflow Automation |
| Cloud & Tools | Hugging Face, W&B, Jupyter, VS Code |
